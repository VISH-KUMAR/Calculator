...
public class SpeedController implements Initializable {
	...
	ObservableList<String> list = FXCollections.observableArrayList("Meter/sec", "Kilometer/hour", "Miles/hour");
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		combo1.setValue("Meter/sec");
		combo2.setValue("Meter/sec");
...
//			label2.setText(String.valueOf(calc.speedConversion(n, combo1.getValue(), combo2.getValue())));
			handlelabel2(label1.getText());
			} else {
//			n = Double.parseDouble(label2.getText());
//			label1.setText(String.valueOf(calc.speedConversion(n, combo2.getValue(), combo1.getValue())));
				handlelabel1(label2.getText());
		}
	}
	...
	void processDelKey(ActionEvent ae) {
		...
		// label2.setText(String.valueOf(calc.speedConversion(Double.parseDouble(label1.getText()),
		...
		// label1.setText(String.valueOf(calc.speedConversion(Double.parseDouble(label2.getText()),
		// combo1.getValue(), combo2.getValue())));
		//
		// } else {
		// label2.setText("0");
